...
from src.models import (  # noqa: F401
    User, Agent, PasswordResetToken, MCPConnection, 
    FileSearchStore, FileSearchFile, Plan, UserTokenBalance, TokenUsageHistory
)
...
# Set the database URL from our Config (only when needed, not during import)
...
def run_migrations_online() -> None:
    ...
    """
    # Ensure we use the correct database URL from Config
